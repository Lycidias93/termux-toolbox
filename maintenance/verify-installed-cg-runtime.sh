...
grep -Fq 'CG_HANDOFF_CGLINT_GATE_V1' "$BIN_DIR/cg-handoff" ||
	fail 'cg_handoff_cglint_gate_marker_missing'
grep -Fq 'run_preflight cglint "$dst"' "$BIN_DIR/cg-handoff" ||
	fail 'cg_handoff_cglint_gate_call_missing'
