...
run_clean() {
  # Keep CG state hermetic while retaining the host execution substrate.
  # Termux needs both its PATH and termux-exec LD_PRELOAD for direct execution
  # of scripts with portable /usr/bin/env shebangs inside the fixture.
  env -i \
    PATH="$BIN:$HOST_PATH" \
